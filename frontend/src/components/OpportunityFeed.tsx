...
export default function OpportunityFeed({ opportunities }: { opportunities: Opportunity[] }) {
  return (
    <div className="flex h-full max-h-full min-h-0 flex-col overflow-hidden rounded-lg border border-bg-border bg-bg-panel p-3">
      <div className="mb-2 shrink-0 text-xs uppercase tracking-wide text-ink-faint">
